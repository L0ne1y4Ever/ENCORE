...
| `TBD` | feat | Added backend admin show CRUD and connected the admin show page to real create/edit/publish/archive operations. | `mvn test` passed; `npm run build` passed; real admin show CRUD API flow passed; browser admin show page and create dialog loaded. | Pending push |
