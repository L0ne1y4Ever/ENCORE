...
| Pending | feat | Integrated frontend auth and show browsing with backend APIs using Axios and `VITE_API_BASE_URL`. | `npm run build` passed; CORS preflight for Vite origin passed; backend login from Vite origin passed. | Not pushed |
