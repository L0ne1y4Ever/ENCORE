...
| `4751176` | feat | Added backend ticket check-in verification, connected scanner UI to real API, and stabilized the latest frontend UI/i18n changes. | `mvn test` passed; `npm run build` passed; real API purchase/pay/check-in flow passed; browser scanner success and duplicate rejection passed. | Pending |
