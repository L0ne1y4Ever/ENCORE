...
| `dce8087` | feat | Improved Chinese/English switching with persisted locale, reusable segmented switcher, and localized demo-flow pages. | `npm run build` passed; Chrome headless verified login/home language switching and persisted locale. | Pending push |
